...
import com.tezov.lib_adr_app_core.ui.extension.ExtensionComposable
import com.tezov.lib_adr_app_core.ui.extension.ExtensionComposable.loopOver
    ...
    operator fun invoke(
        ...
        Column(
            ...
            Column(
                ...
                data.tile.loopOver {
                    val first = nextOrNull
                    val second = nextOrNull
